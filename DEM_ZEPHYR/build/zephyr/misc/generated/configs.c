...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_DEMEDUKIT_ESP32, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_DEMEDUKIT_ESP32_ESP32_PROCPU, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SRAM_BASE_ADDRESS, 0x40070000);
